  ...
  return (
    <div className="about-section" id="about">
      ...
      <div className="about-text-content">
        ...
        With a deep commitment to evidence-based care, Dr. Lodhi holds multiple advanced certifications, including Dry Needling, Myofascial Kinesio Taping, Osteopathy, and Chiropractic Therapy. 
        ...
        Dr. Lodhi is dedicated to empowering individuals on their journey toward recovery, resilience, and long-term well-being.
        </p>
