  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Vaishali PhysioCare&Rehab <img className="navbar-sign" src={Doctor} alt="Doctor"/>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Vaishali PhysioCare, your trusted healthcare platform. Our
        ...
        <p className="legal-description">
          When using Vaishali PhysioCare, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Vaishali PhysioCare&Rehab is designed to simplify healthcare access. You can choose
          a specialist, schedule an appointment, and engage in a virtual
          consultation. We offer personalized advice and treatment
